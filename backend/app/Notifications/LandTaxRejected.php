...
class LandTaxRejected extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $message = (new MailMessage)
            ->subject('Land Tax Registration Rejected')
            ->greeting('Hello ' . $notifiable->name . ',')
            ->line('Your land tax registration has been rejected.')
