...
class MutationFlagged extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $message = (new MailMessage)
            ->subject('Mutation Application Flagged')
            ->greeting('Hello ' . $notifiable->name . ',')
            ->line('Your mutation application has been flagged for review.')
